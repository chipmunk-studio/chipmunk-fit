...
FitColors lightFitColors = FitColors(
  ...
  redAlpha72: ChipColors.redAlphaBase.withAlpha((255 * 0.72).toInt()),
  redAlpha48: ChipColors.redAlphaBase.withAlpha((255 * 0.48).toInt()),
  redAlpha24: ChipColors.redAlphaBase.withAlpha((255 * 0.24).toInt()),
  redAlpha12: ChipColors.redAlphaBase.withAlpha((255 * 0.12).toInt()),
  blueAlphaBase: ChipColors.blueAlphaBase,
  blueAlpha72: ChipColors.blueAlphaBase.withAlpha((255 * 0.72).toInt()),
  blueAlpha48: ChipColors.blueAlphaBase.withAlpha((255 * 0.48).toInt()),
  blueAlpha24: ChipColors.blueAlphaBase.withAlpha((255 * 0.24).toInt()),
  blueAlpha12: ChipColors.blueAlphaBase.withAlpha((255 * 0.12).toInt()),
  yellowBase: ChipColors.yellowAlphaBase,
  yellowAlpha72: ChipColors.yellowAlphaBase.withAlpha((255 * 0.72).toInt()),
  yellowAlpha48: ChipColors.yellowAlphaBase.withAlpha((255 * 0.48).toInt()),
  yellowAlpha24: ChipColors.yellowAlphaBase.withAlpha((255 * 0.24).toInt()),
  yellowAlpha12: ChipColors.yellowAlphaBase.withAlpha((255 * 0.12).toInt()),
  greenBase: ChipColors.greenAlphaBase,
  greenAlpha72: ChipColors.greenAlphaBase.withAlpha((255 * 0.72).toInt()),
  greenAlpha48: ChipColors.greenAlphaBase.withAlpha((255 * 0.48).toInt()),
  greenAlpha24: ChipColors.greenAlphaBase.withAlpha((255 * 0.24).toInt()),
  greenAlpha12: ChipColors.greenAlphaBase.withAlpha((255 * 0.12).toInt()),
  periwinkleBase: ChipColors.periwinkleAlphaBase,
  periwinkleAlpha72: ChipColors.periwinkleAlphaBase.withAlpha((255 * 0.72).toInt()),
  periwinkleAlpha48: ChipColors.periwinkleAlphaBase.withAlpha((255 * 0.48).toInt()),
  periwinkleAlpha24: ChipColors.periwinkleAlphaBase.withAlpha((255 * 0.24).toInt()),
  periwinkleAlpha12: ChipColors.periwinkleAlphaBase.withAlpha((255 * 0.12).toInt()),
  ...
  inverseDisabled: ChipColors.grey400.withOpacity(0.8),
  dimBackground: ChipColors.staticBlack.withOpacity(0.6),
  dimOverlay: ChipColors.staticWhite.withOpacity(0.76),
...
FitColors darkFitColors = FitColors(
  ...
  redAlpha72: ChipColors.redAlphaBaseDark.withAlpha((255 * 0.72).toInt()),
  redAlpha48: ChipColors.redAlphaBaseDark.withAlpha((255 * 0.48).toInt()),
  redAlpha24: ChipColors.redAlphaBaseDark.withAlpha((255 * 0.24).toInt()),
  redAlpha12: ChipColors.redAlphaBaseDark.withAlpha((255 * 0.12).toInt()),
  yellowBase: ChipColors.yellowAlphaBaseDark,
  blueAlphaBase: ChipColors.blueAlphaBaseDark,
  blueAlpha72: ChipColors.blueAlphaBaseDark.withAlpha((255 * 0.72).toInt()),
  blueAlpha48: ChipColors.blueAlphaBaseDark.withAlpha((255 * 0.48).toInt()),
  blueAlpha24: ChipColors.blueAlphaBaseDark.withAlpha((255 * 0.24).toInt()),
  blueAlpha12: ChipColors.blueAlphaBaseDark.withAlpha((255 * 0.12).toInt()),
  yellowAlpha72: ChipColors.yellowAlphaBaseDark.withAlpha((255 * 0.72).toInt()),
  yellowAlpha48: ChipColors.yellowAlphaBaseDark.withAlpha((255 * 0.48).toInt()),
  yellowAlpha24: ChipColors.yellowAlphaBaseDark.withAlpha((255 * 0.24).toInt()),
  yellowAlpha12: ChipColors.yellowAlphaBaseDark.withAlpha((255 * 0.12).toInt()),
  greenBase: ChipColors.greenAlphaBaseDark,
  greenAlpha72: ChipColors.greenAlphaBaseDark.withAlpha((255 * 0.72).toInt()),
  greenAlpha48: ChipColors.greenAlphaBaseDark.withAlpha((255 * 0.48).toInt()),
  greenAlpha24: ChipColors.greenAlphaBaseDark.withAlpha((255 * 0.24).toInt()),
  greenAlpha12: ChipColors.greenAlphaBaseDark.withAlpha((255 * 0.12).toInt()),
  periwinkleBase: ChipColors.periwinkleAlphaBaseDark,
  periwinkleAlpha72: ChipColors.periwinkleAlphaBaseDark.withAlpha((255 * 0.72).toInt()),
  periwinkleAlpha48: ChipColors.periwinkleAlphaBaseDark.withAlpha((255 * 0.48).toInt()),
  periwinkleAlpha24: ChipColors.periwinkleAlphaBaseDark.withAlpha((255 * 0.24).toInt()),
  periwinkleAlpha12: ChipColors.periwinkleAlphaBaseDark.withAlpha((255 * 0.12).toInt()),
  ...
  dimBackground: ChipColors.staticBlack.withOpacity(0.6),
  dimOverlay: ChipColors.staticBlack.withOpacity(0.76),
