...
class FitDialog {
  ...
  static Future<T?> makeErrorDialog<T>({
    required BuildContext context,
    required String message,
    String? description,
    required VoidCallback onPress,
    ...
    return showErrorDialog<T>(
      ...
      textStyle: textStyle,
      btnOkColor: btnOkColor,
      btnOkTextColor: buttonTextStyle?.color,
      btnOkText: btnOkText,
      borderRadius: borderRadius,
    );
  }

  @Deprecated('Use showFitDialog instead')
  static Future<T?> makeFitDialog<T>({
    required BuildContext context,
    String? title,
    String? subTitle,
    String? btnOkText,
