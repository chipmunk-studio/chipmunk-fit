...
const FitColors lightFitColors = FitColors(
  ...
  grey800: Color(0xFFEBEDF0),
  grey700: Color(0xFFCBCBCD),
  grey600: Color(0xFFA2A6AC),
  grey500: Color(0xFF80858C),
  grey400: Color(0xFF585C62),
  grey300: Color(0xFF3C3F43),
  grey200: Color(0xFF2E3033),
  grey100: Color(0xFF141517),
  white: Color(0xFF000000),
  black: Color(0xFFFFFFFF),
  primary: Color(0xFFEC1086),
  secondary: Color(0xFFFFE5B0),
  positive: Color(0xFFD850A7),
  positiveLight: Color(0xFF091011),
  negative: Color(0xFF10ADFF),
  negativeLight: Color(0xFF051D27),
  negativeDark: Color(0xFFCCE2E8),
